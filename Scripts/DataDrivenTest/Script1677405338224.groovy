...
response1 = WS.sendRequest(findTestObject('CountryInfoSOAPService/GetCapital', [('CountryISOCode') : CountryISOCode ]))

WS.verifyElementText(response1, 'CapitalCityResponse.CapitalCityResult', Capital )

response2 = WS.sendRequest(findTestObject('CountryInfoSOAPService/GetCurrency', [('CountryISOCode') : CountryISOCode ]))
